...
package com.jmrogado.liferay.customer.service.persistence;
...
/**
 * The persistence utility for the customer service. This utility wraps <code>com.jmrogado.liferay.customer.service.persistence.impl.CustomerPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CustomerUtil {
	 ...
	 * @throws NoSuchCustomerException if a customer with the primary key could not be found
	 */
	public static Customer findByPrimaryKey(long id)
		throws com.jmrogado.liferay.customer.exception.NoSuchCustomerException {
	 ...
	 */
	public static Customer fetchByPrimaryKey(long id) {
