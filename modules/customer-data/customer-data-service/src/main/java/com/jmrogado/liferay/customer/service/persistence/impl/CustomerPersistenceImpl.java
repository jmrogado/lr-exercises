...
package com.jmrogado.liferay.customer.service.persistence.impl;
...
import com.jmrogado.liferay.customer.model.CustomerTable;
import com.jmrogado.liferay.customer.model.impl.CustomerImpl;
import com.jmrogado.liferay.customer.model.impl.CustomerModelImpl;
import com.jmrogado.liferay.customer.service.persistence.CustomerPersistence;
import com.jmrogado.liferay.customer.service.persistence.CustomerUtil;
import com.jmrogado.liferay.customer.service.persistence.impl.constants.MYAPPPersistenceConstants;
...
public class CustomerPersistenceImpl
	...
	public Customer[] findByUuid_PrevAndNext(
			long id, String uuid, OrderByComparator<Customer> orderByComparator)
		throws NoSuchCustomerException {
	 ...
	 */
	@Override
	public Customer remove(long id) throws NoSuchCustomerException {
	 ...
	 */
	@Override
	public Customer findByPrimaryKey(long id) throws NoSuchCustomerException {
	 ...
	 */
	@Override
	public Customer fetchByPrimaryKey(long id) {
